...
export const customer_list_wash = (req, res) => {
  ...
  try {
    ...
    const bookingIdQuery = "SELECT bookings.id FROM bookings left join booking_qr on booking_qr.driver_pickup_status = 1 WHERE and bookings.folder_id = '"+folder_id+"' and bookings.date = '"+currentFinalDate+"'";
