...
export const booking_tracking_details = async(req,res)=>{
        ...
        try { 
            ...
            resultss.forEach(element =>
            {
                ...
                const initi = {
                    "id":id,"category_id":category_id,"address":address,'total_amount':total_amount,'rating_id':rating,'rating_feedback':rating_feed,"user_id":user_id,"name":name,"email":email,"mobile":mobile,"order_id":order_id,"order_type":order_type,'laundry_detail':laundry_detail
                }
            ...
            resultss.forEach(element =>
            {
                ...
                const initi = {
                    "id":id,"category_id":category_id,"address":address,'total_amount':total_amount,'rating_id':rating,'rating_feedback':rating_feed,"order_id":order_id,"user_id":user_id,"name":name,"email":email,"mobile":mobile,"order_type":order_type,'laundry_detail':laundry_detail
                }
                res.json({'status':true,"message":"user order list","order_id":order_id,"user_id":user_id,"name":name,"email":email,"mobile":mobile,'extra_loads':extra_loads,'total_loads':total_loads,'deliever_date':deliever_date,'data':initi});
                }
            })
