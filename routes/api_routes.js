...
router.post('/order-managament-user-update',upload.fields([{ name: "licence_front_image", maxCount: 1 },{ name: "licence_back_image", maxCount: 1 },{ name: "profile_image", maxCount: 1 },]),userController.order_managament_user_singup);
